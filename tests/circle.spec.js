...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  ...
  test(' Teste se dentro do objeto retornado, a função retorna uma key com value igual a circunferência correta para um círculo de raio 2.', () =>{
    expect(circle(2).circumference).toEqual(12.56);
  })
  test('Teste se dentro do objeto retornado, a função retorna uma key com value igual a área correta para um círculo de raio 3.', () =>{
